...
function applyGuestMode() {
  ...
  if (headerActions) {
    headerActions.innerHTML = `
      <a href="index.html" class="guest-masuk-btn">
  ...
  if (pageBody) {
    ...
    banner.innerHTML = `
      ...
      <span>Kamu sedang menjelajah sebagai tamu. <a href="index.html">Masuk</a> atau <a href="index.html">Daftar</a> untuk melamar lowongan.</span>`;
