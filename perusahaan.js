...
function renderCompany(co, hasApplied, userReview) {
  ...
  const avgRating = allReviews.length
    ...
    : co.rating;
  const totalCount = allReviews.length || co.reviewCount;
    ...
    ${hasApplied ? `
      <div class="pr-review-cta">
        ${userReview
          ...
          : `<p>Sudah pernah magang di sini?</p><a href="review.html?id=${co.id}" class="pr-write-review-btn" style="display:inline-flex;align-items:center;gap:6px;margin-top:8px">✍️ Tulis Review</a>`}
      </div>` : ''}
